...
class User(db.Model):
    ...
    def set_password(self, password):
        ...
        self.updated_at = datetime.now()  # Create password timestamp
...
class House(db.Model):
    ...
    characters = db.relationship('Character', backref='house_ref', lazy=True, cascade="none")
...
class Role(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(100), unique=True, nullable=False)
    characters = db.relationship('Character', backref='role_ref', lazy=True, cascade="none")
...
class Strength(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(100), unique=True, nullable=False)
    characters = db.relationship('Character', backref='strength_ref', lazy=True, cascade="none")
