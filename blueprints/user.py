...
from controllers.user_controllers.user_controller_for_view_character_list import my_character_list
from controllers.user_controllers.user_controller_for_add_character import user_add_character
from controllers.user_controllers.user_controller_for_delete_character import delete_character
from controllers.user_controllers.user_controller_for_edit_character import user_edit_character

from controllers.user_controllers.user_controller_for_view_user_profile import user_profile
from controllers.user_controllers.user_controller_for_edit_user_profile import edit_user_profile
...
user_bp.route('/edit_character/<int:character_id>', methods=['GET', 'POST'])(user_edit_character)
user_bp.route('/delete_character/<int:character_id>', methods=['POST'])(delete_character)
