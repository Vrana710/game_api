...
from models import Character, House, Role, Strength
...
def my_character_list():
    ...
    if user is None:
        return handle_invalid_user()  # Handle case where the user object is invalid
    ...
    # Filter by age (greater than or equal to 'age_more_than' and less than or equal to 'age_less_than')
    ...
    # Sorting logic
    sort_column = request.args.get('sort_column', 'name')  # Default to sorting by name
