...
from models import Character, House, Strength, Role
from controllers.common_fun import user_logged_in, handle_invalid_user, handle_not_logged_in, handle_character_update
...
def user_edit_character(character_id):
    ...
    if user is None:
        return handle_invalid_user()  # Handle case where the user is invalid
    ...
    if character.user_id != user.id:
        ...
        return redirect(url_for('user_bp.my_character_list'))  # Redirect to user's characters list page
